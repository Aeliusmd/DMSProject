...
CREATE TABLE orders (
  ...
  ssn_last_four   VARCHAR(11)     NULL COMMENT 'Masked SSN XXX-XX-1234 (X replaces real leading digits)',
  dob             DATE            NULL,
...
CREATE TABLE invoices (
  ...
  payment_method    ENUM('manual', 'online') NULL,
  payment_check_number VARCHAR(50)  NULL,
  payment_date      DATE            NULL,
  payment_recorded_by BIGINT UNSIGNED NULL,
